<template>
  <div>
    ...
    <section class="lg:py-16 py-10 max-w-4/5 mx-auto container">
      ...
      <div v-else>
        <h4 class="text-center font-arial-black text-2xl lg:text-3xl lg:py-20 py-20">Coming soon...</h4>
      </div>
  ...
  const loadData = function ({
    ...
    return api
      .get(`cdn/stories${path}`, {
        ...
        resolve_relations: 'upcoming-webinar-container.upcoming_webinars',
        cv: cacheVersion,
      })
      .then((res) => {
        return res.data
